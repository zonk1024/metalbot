...
CREATE TABLE songlist (id integer primary key autoincrement, filename string, artist string, album string, date int, track int, title string, lastmodified int);
